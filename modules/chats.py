...
<head>
    ...
    <title>Spatial Network - Tiempo Real</title>
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif; }
        ...
        .chat-room-user .avatar { width: 40px; height: 40px; border-radius: 50%; }
        ...
        #connection-status { font-size: 10px; padding: 2px 8px; border-radius: 4px; background: #ef4444; color: #fff; margin-left: 10px; }
...
<body>
    ...
    <div id="view-chats" class="view active">
        <div class="header-list">
            <div class="header-title">Spatial Network <span id="connection-status">Conectando...</span></div>
            ...
            <div class="chat-item" onclick="openChat('Soporte / General', 'user_system', 'online')">
                ...
                <div class="chat-info">
                    <div class="chat-header-row">
                        <span class="chat-name">Soporte General (Tiempo Real)</span>
    ...
    <div id="view-novedades" class="view">
        <div class="placeholder-content">
            <span>⚡</span>
            <p>Novedades y Estados en Tiempo Real</p>
        </div>
    </div>
    ...
    <script>
        ...
        function updatePreview(text) {
            document.getElementById('last-msg-preview').innerText = text;
            document.getElementById('last-time').innerText = 'Ahora';
        }
    </script>
</body>
</html>
